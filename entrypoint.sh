...
VMESS_WARP_WSPATH=${VMESS_WARP_WSPATH:-'/UUID-vmess_warp'}
VLESS_WSPATH=${VLESS_WSPATH:-'/UUID-vless'}
VLESS_WARP_WSPATH=${VLESS_WARP_WSPATH:-'/UUID-vless_warp'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/UUID-trojan'}
TROJAN_WARP_WSPATH=${TROJAN_WARP_WSPATH:-'/UUID-trojan_warp'}
SS_WSPATH=${SS_WSPATH:-'/UUID-shadowsocks'}
SS_WARP_WSPATH=${SS_WARP_WSPATH:-'/UUID-shadowsocks_warp'}
